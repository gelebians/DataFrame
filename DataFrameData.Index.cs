...
namespace ISRA.Data
{
     ...
     * There are DataFrame Indexing methods in the DataFrame.cs file.
     ...
     */
        ...
        public DataFrame this[string[] columns]
        {
            get
            {
                return new DataFrame(_columns.Values.ToList(), columns);
            }
        }
        ...
        /// Renames columns.
        /// </summary>
        /// <param name="columns">Previous column and new name list in Dictionary format</param>
        public void rename(Dictionary<string, string> columns)
        {
